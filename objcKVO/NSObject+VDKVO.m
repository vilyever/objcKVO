...
- (VDKVOElement *)vd_observeKVOWithKeyPath:(NSString *)keyPath action:(void (^)(VDKVOElement *, VDKVOChange *))action {
    VDKVOElement *element = [[VDKVOElement alloc] initWithTarget:self keyPath:keyPath action:action];
